//Code Reference from : http://lostechies.com/derickbailey/2012/02/09/asynchronously-load-html-templates-for-backbone-views/
(function () {
	...
	var loadTemplateAsync = function (tmpId) {
		var promise = promises[tmpId] || $.get("/assets/js/app/templates/" + tmpId + ".html");
		promises[tmpId] = promise;
		return promise;
	}

	// Use jQuery to asynchronously load the template. 
	TemplateManager.loadTemplate = function (templateId, callback) {
